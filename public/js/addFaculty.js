...
function addFaculty(divName)
{
   if (counter == limit)
   {
        alert("You have reached the limit of faculty memebers. If you wish to add more, please contact the Research Days at (908) 737-3461 or researchdays@kean.edu.");
   }
   else
   {
        counter++;
        ...
        newdiv.innerHTML += `<div id=additionalFaculty` + counter + `><hr><div class="form-group row mt-4 col-md-12">
        <h5>Faculty Member ` + counter + `</h5>
    </div>
    <div class="row">
        <div class="form-group col-md-3">
            <label for="firstName` + counter + `">First name</label>
            <input type="text" class="form-control" id="firstName` + counter + `" name="firstName` + counter + `" required="true">
        </div>
        <div class="form-group col-md-3">
            <label for="lastName` + counter + `">Last name</label>
            <input type="text" class="form-control" id="lastName` + counter + `" name="lastName` + counter + `" required="true">
        </div>
        <div class="form-group col-md-2">
            <label for="facultyPosition` + counter + `">Position</label>
            <select name="facultyPosition` + counter + `" required id="facultyPosition` + counter + `" class="form-control">
    ...
    <div class="row">
        <div class="form-group col-md-3">
            <label for="campus` + counter + `">Campus</label>
        ...
        <div class="form-group col-md-3">
            <label for="keanEmail` + counter + `">Email Address</label>
